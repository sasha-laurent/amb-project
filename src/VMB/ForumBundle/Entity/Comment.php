...
class Comment
{
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="VMB\ForumBundle\Entity\discussion",inversedBy="comments")
    * @ORM\JoinColumn(nullable=false)
    */
    private $discussion;
     ...
     * Set discussion
     *
     * @param \VMB\ForumBundle\Entity\discussion $discussion
     * @return Comment
     */
    public function setDiscussion(\VMB\ForumBundle\Entity\discussion $discussion)
    {
     ...
     * Get discussion
     *
     * @return \VMB\ForumBundle\Entity\discussion 
     */
